...
def create_dask_df():
    ...
    df = dd.read_csv(r"C:\Users\Lenon Torma\Desktop\Jornada_de_dados\bootcamp-python\aula-04\One-Billion-Row-Challenge-Python\data\measurements.txt", sep=";", header=None, names=["station", "measure"])
