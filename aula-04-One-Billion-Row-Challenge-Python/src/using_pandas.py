...
filename = r"C:\Users\Lenon Torma\Desktop\Jornada_de_dados\bootcamp-python\aula-04\One-Billion-Row-Challenge-Python\data\measurements.txt"  # Certifique-se de que este é o caminho correto para o arquivo
