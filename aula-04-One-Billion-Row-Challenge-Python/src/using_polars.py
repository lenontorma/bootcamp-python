...
def create_polars_df():
    ...
    return (
        ...
        pl.scan_csv(r"C:\Users\Lenon Torma\Desktop\Jornada_de_dados\bootcamp-python\aula-04\One-Billion-Row-Challenge-Python\data\measurements.txt", separator=";", has_header=False, new_columns=["station", "measure"], schema={"station": pl.String, "measure": pl.Float64})
        .group_by(by="station")
        .agg(
